...
Prior to analysis, the imported data set must be organized a bit.  Namely, combining year, month and day columns and making provisions for BC and AD dates (to a column or variable called **datevalue**).  
